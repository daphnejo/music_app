...
export default function Screen() {
  return <SafeAreaView style={styles.safe}><Text style={styles.title}>Lessons</Text><View style={styles.card}><Text style={styles.text}>Mobil foundation tayyor. Keyingi milestone’da bu ekran real Solfedjio kontenti va backend API bilan to‘ldiriladi.</Text></View></SafeAreaView>;
}
