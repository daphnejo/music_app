    ...
    <AuthShell>
      <View style={styles.content}>
        ...
        <View style={styles.form}>
          ...
          <Pressable disabled={!ready} onPress={() => void handleLogin()} style={[styles.button, !ready && styles.disabled]}>
...
const styles = StyleSheet.create({
  ...
  passwordRow: { height: 54, flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 16 },
  passwordInput: { flex: 1, height: '100%', paddingLeft: 16, paddingRight: 8, fontSize: 15, color: colors.text },
