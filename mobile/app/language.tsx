  ...
  return (
    <Screen>
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <View style={styles.body}>
            ...
            <Text style={styles.caption}>Hozirgi asosiy til</Text>
          </View>
      ...
      <View style={styles.note}>
        ...
        <Text style={styles.noteText}>Rus va ingliz tillari keyingi lokalizatsiya bosqichida qo‘shiladi. Hozir barcha ekranlar O‘zbek tilida ishlaydi.</Text>
      </View>
    </Screen>
  );
}
...
const styles = StyleSheet.create({
  ...
  caption: { color: colors.muted, marginTop: 3, fontSize: 12 },
